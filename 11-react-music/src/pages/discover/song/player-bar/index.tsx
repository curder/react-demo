...
const PlayerBar: FC<PlayerBarProps> = (props) => {
  ...
  // 切换歌曲
  const changeSongHandle = (flag: boolean = false) => {
  ...
  return (
    <PlayerBarWrapper className="sprite_playbar">
      <div className="player-bar-content wrap-v3">
        ...
        <PlayerBarOperator $playMode={playMode}>
          <div className="left">
